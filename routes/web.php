...
Route::prefix('admin')->name('admin.')->middleware('admin.auth')->group(function () {
    ...
    Route::middleware('admin.role:profil')->group(function () {
    ...
    Route::middleware('admin.role:publikasi_berita')->group(function () {
    ...
    Route::middleware('admin.role:publikasi_pengumuman')->group(function () {
    ...
    Route::middleware('admin.role:publikasi_edukasi')->group(function () {
    ...
    Route::middleware('admin.role:home_thumbnail')->group(function () {
    ...
    Route::middleware('admin.role:home_tile')->group(function () {
    ...
    Route::middleware('admin.role:jurnal')->group(function () {
        Route::view('/jurnal', 'pages.admin.jurnal')->name('jurnal');
    });

    Route::middleware('admin.role:karya_ilmiah')->group(function () {
    ...
    Route::middleware('admin.role:sni')->group(function () {
    ...
    Route::middleware('admin.role:informasi_publik')->group(function () {
    ...
    Route::middleware('admin.role:laporan_skm')->group(function () {
    ...
    Route::middleware('admin.role:geolistrik_1d')->group(function () {
    ...
    Route::middleware('admin.role:gems')->group(function () {
...
Route::prefix('pelayanan_publik')->name('pelayanan_publik.')->group(function () {
    ...
    Route::view('/permintaan_pelayanan/peminjaman_ruangan', 'pages.pelayanan_publik.permintaan_pelayanan_peminjaman_ruangan')->name('permintaan_pelayanan_peminjaman_ruangan');
