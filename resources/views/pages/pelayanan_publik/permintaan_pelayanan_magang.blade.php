        ...
        ">
            <div>
                ...
                <p style="margin: 0; color: #fff; font-size: 20px;">
                    ...
                    <span style="color: #ffd15b;">Permintaan Pelayanan Magang</span>
                </p>
            </div>
        </div>

        <div class="detail-card">
            <h3 style="color: #11274a; margin-bottom: 14px;">Layanan Magang</h3>
            <p style="margin: 0; color: #41556f;">
                Halaman ini digunakan untuk informasi dan pengajuan program magang di lingkungan Balai Air Tanah.
            </p>
        </div>
    </div>
</section>
