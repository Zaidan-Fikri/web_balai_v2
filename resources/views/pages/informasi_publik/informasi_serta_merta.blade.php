...
@section('title', 'Informasi Serta Merta - Balai Air Tanah')
...
@section('content')
    @include('pages.partials.menu_detail_hero', ['menuGroup' => 'Informasi Publik', 'pageTitle' => 'Informasi Serta Merta'])
    ...
    <section class="ib-section">
        <div class="container">
            <nav class="page-breadcrumb" aria-label="Breadcrumb">
                ...
                <span class="bc-sep"><i class="fa-solid fa-chevron-right fa-xs"></i></span>
                <span class="bc-current">Informasi Serta Merta</span>
            </nav>
            <div class="ip-layout">
